...
class RestAPI {
    constructor(options) {
        ...
        this.baseURL = options.baseURL || `https://api.shoonya.com/NorenWClientTP`;
        // initialize ApiRequest instance
        this.apiRequest = new ApiRequest_1.default(this.baseURL, RestAPI.routes, this.accessToken);
